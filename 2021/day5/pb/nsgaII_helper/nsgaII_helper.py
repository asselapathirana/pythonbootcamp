...
Example code::
Following code runs the Kursawe(3) problem of minimization. For clarity, 
all the necessary elements 
(e.g. generator, evaluator, etc) are reproduced here (mygenerator etc.) 
rather than calling from the inspyred library. 
import math
